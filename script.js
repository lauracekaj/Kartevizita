function clearSocials(){
    ...
    if(document.getElementById("github").checked == true){
        document.getElementById("github_show").style.display = "inline";
    }
    if(document.getElementById("linkedin").checked == true){
        document.getElementById("linkedin_show").style.display = "inline";
    }
    if(document.getElementById("twitter").checked == true){
        document.getElementById("twitter_show").style.display = "inline";
    }
    if(document.getElementById("instagram").checked == true){
        document.getElementById("instagram_show").style.display = "inline";
    }
    ...
    if(document.getElementById("facebook").checked == true){
        document.getElementById("facebook_show").style.display = "inline";
    }
